...
if __name__ == "__main__":
    ...
    parallel_commands = [
        ...
        (f"cd {ui} && wget https://github.com/gutris1/segsmaker/raw/main/kaggle/script/pantat88.py -O {ui}/semvak_zeus.py", "Download semvak_zeus.py")
    ]
    ...
    resource_commands = [
        ...
        (f"cd {ui} && aria2c --console-log-level=error -c -x 16 -s 16 -k 1M https://huggingface.co/datasets/Carmeninkunming/fast-repo-kaggle/resolve/main/cache.tar.lz4 -o cache.tar.lz4 && tar -xI lz4 -f cache.tar.lz4--directory=/root/.cache/huggingface/hub && rm {ui}/cache.tar.lz4", "Prepare Huggingface Cache"),
